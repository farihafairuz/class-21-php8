            ...
            <div class="col-md-5 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-capitalize">Calculator</h2>
                    </div>
                    <div class="card-body">
                       <form action="action.php" method="post">
                           ...
                           <div class="form-group row">
                               ...
                               <div class="col-md-8">
                                   ...
                                   <label for="" ><input type="radio" name="option" value="-">subtract</label>
                                   <label for="" ><input type="radio" name="option" value="*">multiply</label>
                                   <label for="" ><input type="radio" name="option" value="/">division</label>
